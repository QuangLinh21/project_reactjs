      ...
      <div className="banner-img">
        ...
        <div className="box-content">
          ...
          <div className="box-content-main">
            <p>
              Sự hòa quyện tuyệt vời giữa hương thơm man mát <br /> của sen
              Bách Diệp Hồ Tây và vị đậm đà của trà Tân Cương
            </p>
          </div>
    ...
    <section className="intro">
      ...
      <div className="box-intro">
        ...
        <div className="box-intro-content">
          <p>
            Trà ướp sen Bích Diệp - Tinh hoa văn hóa Hà Thành là sự hòa
            quyện tuyệt vời giữa hương thơm man mát của bông sen Bách Diệp
            Hồ Tây vị đậm đà của trà Tân Cương Thái Nguyên. Qua đôi bàn tay
            tài hoa và bí quyết bí mật của truyền nhiều đời của người thợ
            trà Thăng Long, tạo ra thức quà tinh túy kết tinh văn hóa ngàn
          ...
          <div className="row common-section d-flex justify-content-center">
            <div className="col-md-2 ">
              <div className="box-people">
                ...
                <div className="box-people-title text-center">
                  ...
                  <p>
                    Nguyễn Cao Dơn được chọn làm đại diện quảng bá văn hóa
                    trà Việt tại ngôi nhà di sản Mã Mây, Hà Nội
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-2 ">
              <div className="box-people text-center">
                ...
                <p>
                  Truyền nhân đời thứ 6 của dòng trà Trường Xuân, Hà Nội.
                  Chia sẻ về nghệ thuật trà đạo, lĩnh vực mà anh dành hơn
                  nửa cuộ đời để nghiên cứu một cách đam mê
                </p>
              </div>
            </div>
            <div className="col-md-2 ">
              <div className="box-people text-center">
                ...
                <p>
                  Vẫn tự tay chọn hoa, tách gạo, thực hiện từng công đoạn
                  ướp trà sen. Cũng như chính bởi nghiện trà, bởi yêu nghề
                  nên cô thiwwus nữ Hà Thành năm xưa vẫn say hương vị trà
                  sen{" "}
                </p>
              </div>
            </div>
            <div className="col-md-2 ">
              <div className="box-people text-center">
                ...
                <p>
                  Vô địch toàn thế giới cuộc thi Tea Master Cup
            ...
            <div className="col-md-2 ">
              <div className="box-people text-center">
                ...
                <p>
                  ...
                  trong một ngôi trường mà việc uống trà và trà cực ngon,
